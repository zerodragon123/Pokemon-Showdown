...
exports.Formats = [
                   ...
                   return [`${set.name || set.species} cannot Mega Evolve and is banned in ${format.name}.`];
                   }
                   },
                   },
                   {
                   ...
                   banlist: ['Arceus', 'Archeops', 'Blaziken', 'Darkrai', 'Deoxys', 'Dialga', 'Dragonite', 'Dugtrio-Base', 'Giratina', 'Groudon', 'Ho-Oh',
